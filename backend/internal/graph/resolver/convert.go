...
func dbCompanyToGQL(c db.Company) *model.Company {
	return &model.Company{
		...
		RegNumber:             textPtr(c.RegNumber),
		IsVatPayer:            c.IsVatPayer,
		BankName:              textPtr(c.BankName),
		Iban:                  textPtr(c.Iban),
	}
}
...
func dbInvoiceToGQL(inv db.Invoice) *model.Invoice {
	...
	return &model.Invoice{
		...
		SellerRegNumber:   textPtr(inv.SellerRegNumber),
		SellerAddress:     inv.SellerAddress,
		SellerCity:        inv.SellerCity,
		SellerCounty:      inv.SellerCounty,
		SellerIsVatPayer:  inv.SellerIsVatPayer,
		SellerBankName:    textPtr(inv.SellerBankName),
		SellerIban:        textPtr(inv.SellerIban),
		BuyerName:         inv.BuyerName,
		BuyerCui:          textPtr(inv.BuyerCui),
		BuyerAddress:      textPtr(inv.BuyerAddress),
		BuyerCity:         textPtr(inv.BuyerCity),
		BuyerCounty:       textPtr(inv.BuyerCounty),
		BuyerIsVatPayer:   boolPtr(inv.BuyerIsVatPayer),
