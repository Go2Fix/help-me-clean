...
import {
  MY_CLEANER_STATS, TODAYS_JOBS,
  MY_CLEANER_REVIEWS, MY_CLEANER_PROFILE,
...
interface CleanerDoc { documentType: string; status: string }
...
export default function DashboardPage() {
  ...
  const docs: CleanerDoc[] = profile?.documents ?? [];
